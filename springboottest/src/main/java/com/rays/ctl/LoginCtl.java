...
public class LoginCtl extends BaseCtl<UserForm, UserDTO, UserServiceInt> {
	...
	public ORSResponse logout(HttpServletRequest req, HttpServletResponse response) {
		...
		System.out.println("pooja jawariya logout");
		return res;
	}
	...
	public ORSResponse uploadPic(@PathVariable Long userId, @RequestParam("file") MultipartFile file,
		...
		System.out.println("User ID id --------------pooja jawariya" + userId);
		...
		System.out.println(doc.getPath() + "path-----Suraj");
		doc.setUserId(userId);
		System.out.println(doc.getUserId() + "id-----Suraj");
